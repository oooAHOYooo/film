...
/**
 * Script Compiler for Lantern (Winter Magical Realism Film)
...
const SCRIPT_NAME = 'Lantern — Winter Magical Realism Film';
...
function syncManifest() {
  ...
  files.forEach(file => {
    if (!manifestFiles.includes(file)) {
      ...
      const actTitle = lastScene ? lastScene.actTitle : 'Discovery & Accident';
...
<head>
  ...
  <link rel="stylesheet" href="script.css?v=20260602">
...
<body class="full-script-page">
    ...
    <div class="script-sticky-bar no-print" id="scriptStickyBar">
      <div class="nav">
        <div class="nav-left">
          ...
          <a class="nav-link" href="/pages/lantern.html" title="Lantern Hub">
            <span class="nav-icon" aria-hidden="true">🔦</span>
            <span class="nav-text">Lantern</span>
          </a>
  ...
  <script>
    ...
    const MARKDOWN_FILE_NAME = 'lantern_full_script.md';
    ...
    (function initStatusBar() {
      ...
      function updateStatusBar() {
        const sceneHeadings = content.querySelectorAll('h3[id^="scene-"]');
...
// Derive a one-line summary from scene content
function deriveSummary(content) {
  ...
  for (const line of lines) {
    ...
    if (line.startsWith('*') && line.includes('ID:') && line.includes('File:')) continue;
...
<body class="plot-cards-page">
  <div class="gallery-container">
    ...
    <nav class="nav no-print plot-cards-nav">
      <div class="nav-left">
        <a class="nav-link" href="/pages/lantern.html" title="Lantern Hub">🔦 Lantern</a>
