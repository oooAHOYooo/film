...
**Drafting note:** Scene files are intentionally numbered (`s01.md`, `s02.md`, …) so you can freely change scene names later without renaming files. Stable “nicknames” live in `manifest.json` as `nickname` (currently identical to `id`).
...
|---|--------------|-------------------|
| 01 | **Arrival & Discovery** `s01.md` | Dallas at new house with boxes; Makayla and Asher approach, see the oscillator. |
| 02 | **Dallas Night** `s02.md` | Dallas at night; early marsh / equipment. |
| 03 | **The Hum** `s03.md` | First hum; Dallas records or reacts to the sound. |
| 04 | **The Fellowship** `s04.md` | Church picnic at CPC; Dallas and Dominic; Janice, Makayla, Asher; Work, Quinnipiac, bioacoustics; walk home toward marsh. |
| 05 | **Marsh Trail** `s05.md` | Continuation along trail; coastal / marsh atmosphere. |
| 06 | **News Vans & Trash Cans** `s06.md` | News vans in town; Pat Clendenen, Nor'easter; trash / neighborhood. |
| 07 | **The Coordinates** `s07.md` | Dominic's house; burn mark, photo of wife/kid, Mr. Mike, "45 L 15 R"; Janice, brussels, Howie dog-sit. |
| 08 | **Dallas Marsh Walk** `s08.md` | Dallas (and Howie?) along coastal trail; marsh, receiver. |
| 09 | **Dallas Night Work** `s09.md` | Dominic and Asher pick up Howie; invite to picnic; Dallas at window, equipment, late wife photo, hum, shadows in grass. |
| 10 | **Shadows in Wind** `s10.md` | Dallas walks Howie; reader spikes near tall grass; dogs/coyotes, storm alert; the hum builds; Howie afraid, they move on. |
| 11 | **Howie Walk (Edge of Marsh)** `s11.md` | Dallas at window, shadows in grass, hum; Dominic and Asher collect Howie; life group Thursday; something in the marsh. |
...
| # | Scene / file | Brief description |
|---|--------------|-------------------|
| 12 | **The Burn Mark & Costco** `s12.md` | Dallas walks Howie at Branford rocks; reader spikes near tall grass; dogs, coyotes, storm alert; the hum; Howie pulls him back to porch. |
| 13 | **Entering Grass & The Hollow** `s13.md` | Dallas in tall grass; hollow, eyes in reeds; cry; he approaches. |
...
- **01–11** Act I (arrival → howie walk).
- **12–23** Act II (burn mark → creature missing).
- **24–27** Act III (marsh confrontation → last dinner).
- **28–29** Act IV (final echoes → aftermath).
