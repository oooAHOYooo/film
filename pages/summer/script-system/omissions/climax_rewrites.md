# Climax Omissions Log

**Reason for Omissions:**
The original sequence of Scenes 22-25 created a structural "double rescue" loop. The characters went into the grass to rescue the creature, returned to the house to set the trap, and fired it from the porch. This repetitive action drained the tension from the third act and limited the runtime. To reach the 90-minute goal and increase the cinematic scope of the finale, these scenes were cut and rewritten into an extended "Fight to the Marsh" sequence where the characters must carry the heavy equipment *into* the dangerous tall grass to make their final stand.

---

## Omitted Scene 22: The Elders (Original Version)
*Cut because the rescue in the grass caused them to immediately run back to the house, removing the tension of being trapped in the marsh.*
...
## Omitted Scene 23: The Final Setup (Original Version)
*Cut because the characters return to the safety of the house, which stops the momentum.*
...
## Omitted Scene 24: Holding the Line (Original Version)
*Cut because this short transitioning scene is no longer necessary if the trap is built dynamically under fire in the marsh.*
...
## Omitted Scene 25: The Climax (Original Version)
*Cut because the final blast should happen in the hostile environment of the marsh, rather than the porch.*
